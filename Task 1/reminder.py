class Reminder():
    ...
    def check_reminders(reservations):
        ...
        for res in reservations:   
            ...
            # Check if the reservation has just officially started
            ...
            # Check if the reservation is starting soon
            ...
            # Check if the reservation is ending soon
